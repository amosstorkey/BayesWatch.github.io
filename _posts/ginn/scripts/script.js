...
//var xLayerDict = new Object();
//var yLayerDict = new Object();
...
var originalImg = new Image(200,200);

originalImg.onload = function(){ // always fires the event.
    // ...
};
originalImg.src = "ginp.png";
...
function load(value) {
    ...
    //if (value < 1/2) {
   //     value = Math.round(1000 * (value / (1/2)));
    //} else {
   //     value = Math.round(totalIterations * (value - 1/2) / (1/2))
   // }
